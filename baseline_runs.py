...
# Data files
BEE_COUNT_FILE = os.path.join('data', 'baseline', 'bee_count.npy')
NECTAR_FILE = os.path.join('data', 'baseline', 'nectar.npy')
RECRUITED_FILE = os.path.join('data', 'baseline', 'recruited.npy')
EXPLORERS_FILE = os.path.join('data', 'baseline', 'explorers.npy')
